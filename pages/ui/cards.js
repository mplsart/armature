...
import StandardCardArticle from '../../src/ui/cards/standard/StandardCardArticle';
...
const resource = {"_meta": {"is_verbose": true, "resource_type": "EventDateModel"},
    "category": "ongoing",
    "end": "2018-11-03T05:00:00Z",
...
"start": "2018-10-17T05:00:00Z", "type": "reoccurring",
...
const eventdate_resource2 = {"_meta": {"is_verbose": true, "resource_type": "EventDateModel"}, "category": "reception", "end": "2018-09-13T03:00:00Z", "event_resource": {"_meta": {"is_verbose": true, "resource_type": "EventModel"}, "featured": false, "name": "JXTA Golden Ale Release Party", "primary_image_resource": {"_meta": {"is_verbose": true, "resource_type": "FileContainer"}, "caption": null, "created_date": "2018-09-10T02:50:36Z", "modified_date": "2018-09-10T02:50:36Z", "resource_id": "RmlsZUNvbnRhaW5lch4fMjgwODAwMDE", "resource_url": "/api/files/RmlsZUNvbnRhaW5lch4fMjgwODAwMDE", "versions": {"CARD_LARGE": {"height": 472, "url": "https://storage.googleapis.com/cdn.mplsart.com/file_container/RmlsZUNvbnRhaW5lch4fMjgwODAwMDE/card_large.png", "width": 900}, "CARD_PROGRESSIVE": {"height": 21, "url": "https://storage.googleapis.com/cdn.mplsart.com/file_container/RmlsZUNvbnRhaW5lch4fMjgwODAwMDE/card_progressive.png", "width": 40}, "CARD_SMALL": {"height": 184, "url": "https://storage.googleapis.com/cdn.mplsart.com/file_container/RmlsZUNvbnRhaW5lch4fMjgwODAwMDE/card_small.png", "width": 350}, "FULL": "", "SIZED": "", "THUMB": {"height": 160, "url": "https://storage.googleapis.com/cdn.mplsart.com/file_container/RmlsZUNvbnRhaW5lch4fMjgwODAwMDE/thumb.png", "width": 160}}}, "primary_image_resource_id": "RmlsZUNvbnRhaW5lch4fMjgwODAwMDE", "resource_id": "RXZlbnQeHzU3MTg4NDgzMDkyOTcxNTI", "slug": "jxta-golden-ale-release-party", "summary": "", "url": "https://www.facebook.com/events/704282016573877/"}, "label": "Release Party", "resource_id": "98400efa8fa04129a3e14d122995ee6c", "start": "2018-09-12T23:00:00Z", "type": "timed", "venue_resource": {"_meta": {"is_verbose": false, "resource_type": "Venue"}, "address": "1300 2nd St NE", "address2": "", "category": "business", "city": "Minneapolis", "country": "USA", "geo": [{"lat": 45.001129, "lon": -93.26641849999999}], "is_premium_profile": false, "multiple_locations_label": "", "name": "Dangerous Man Brewing Co", "nickname": null, "primary_image_resource": null, "primary_image_resource_id": null, "resource_id": "VmVudWUeZGFuZ2Vyb3VzLW1hbi1icmV3aW5nLWNv", "resource_url": "/api/venues/VmVudWUeZGFuZ2Vyb3VzLW1hbi1icmV3aW5nLWNv", "slug": "dangerous-man-brewing-co", "state": "MN", "summary": ""}, "venue_slug": "dangerous-man-brewing-co"};
...
class Index extends React.Component {
  render() {
    return (
      ...
      <pre>import StandardCardEventDate from 'armature/dist/ui/cards/standard/StandardCardEventDate';</pre>
      ...
      <Row>
        ...
        <Col xs={3}>
          <StandardCardEventDate
            event_resource={eventdate_resource2.event_resource}
            event_date_resource={eventdate_resource2}
            linkClassProps={
              {'data-ga-category': 'event-pod-click',
                to:'/events/asdf'
              }}
        ...
        <Col xs={3}>
          <StandardCardArticle
            ...
            linkClassProps={
              {'data-ga-category': 'event-pod-click',
                to:'/written/' + article_resource.slug
              }}
            linkClass={'a'}
          />
        </Col>
      ...
      <Row>
        <Col xs={9}>
          <MarqueeCardEvent
            ...
            linkClassProps={
                {'data-ga-category': 'event-pod-click',
                  to:'/events/' + event_resource2.slug
                }}
            linkClass={'a'}
          />
          <br />
